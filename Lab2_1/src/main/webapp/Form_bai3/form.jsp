...
<body>
    <h1>Đăng kí</h1>
    <form action="/dang_ki_bai3" method="post">
        ...
        Sở thích:
        <input name="hobies" type="checkbox" value="R">Đọc sách
        <input name="hobies" type="checkbox" value="T">Du lịch
        <input name="hobies" type="checkbox" value="M">Âm nhạc
        <input name="hobies" type="checkbox" value="O">Khác
        <br>
